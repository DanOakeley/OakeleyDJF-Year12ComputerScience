...
def Settings_Menu():
    ...
    while not MenuDone:
        ...
        pygame.draw.rect(screen, YELLOW, (0,0,display_width,150))
        drawTextBlack(screen, str(Title), 50, 150, 50)
        drawTextBlack(screen, str(Options1), 20, 80, 150)
        drawTextBlack(screen, str(Options2), 20, 140, 170)
        drawTextBlack(screen, str(Options3), 20, 125, 220)
        drawTextBlack(screen, str(Options4), 20, 137, 240)
        drawTextBlack(screen, str(Options5), 20, 123, 260)
        drawTextBlack(screen, str(CloseText), 20, 120, 450)
...
# -- Game logic goes after this comment
        ...
        drawTextWhite(screen, str(Leftscore), 18, 20, 10)
        drawTextWhite(screen, str(Rightscore), 18, 620, 10)
        # -- flip display to reveal new position of objects
        pygame.display.flip()
        # - e clock ticks over
        clock.tick(60)
